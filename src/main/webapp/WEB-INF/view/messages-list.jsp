	...
	<div id = "body">
		...
		<div id = "main">
			<table class = "score text">
				...
				<div id = "myinput" class="input-group input-group-lg mb-3">
				  <div class="input-group-prepend">
				    <span class="input-group-text" id="inputGroup-sizing-lg">Text</span>
				  </div>
				  <form:form action = "addMessage" modelAttribute = "message" metod = "POST">
				  	  <form:input path = "text" class="form-control" aria-label="Large" aria-describedby="inputGroup-sizing-sm"/>
